...
public class Constants {
    ...
    public static final String TOKEN_DIR = "E:\\token"; //token 文件存储目录
...
//        public static final String TABLE_NAME = "pa:passtemplate"; //PassTemplate HBase 表名
        public static final String TABLE_NAME = "pb:passtemplate"; //PassTemplate HBase 表名

        //基本信息列族
        public static final String FAMILY_B = "b";

        public static final String ID = "id"; // 所属 商户 id
...
//        public static final String TABLE_NAME = "pa:pass"; //Pass HBase 表名
        public static final String TABLE_NAME = "pb:pass"; //Pass HBase 表名
...
//        public static final String TABLE_NAME = "pa:feedback"; //Feedback HBase 表名
        public static final String TABLE_NAME = "pb:feedback"; //Feedback HBase 表名
...
//        public static final String TABLE_NAME = "pa:user"; //User HBase 表名
        public static final String TABLE_NAME = "pb:user"; //User HBase 表名
